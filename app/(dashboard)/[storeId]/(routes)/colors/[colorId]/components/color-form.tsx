...
//Aqui se va a crear el type para los valores que tendremos en el color, esto es para no tener que estar llamando al objeto mas adelante sino al type. 
...
export const ColorForm: React.FC<ColorFormProps> = ({initialData}) => {
    ...
    const onSubmit = async (data: ColorFormValues) => {
        ...
        try{
            ...
            router.refresh();
            //Aqui se redirije a la pestanna colores.
    ...
    //Aqui se va a crear la funcion de borrar colores.
    ...
    //Aqui se va a crear el Form de los colores.
    return(
        <>
                        ...
                        <FormItem>
                            ...
                            <FormControl>
                                <div className="flex items-center gap-x-4">
                                    <Input disabled={loading} placeholder="Color #-num" {...field} />
